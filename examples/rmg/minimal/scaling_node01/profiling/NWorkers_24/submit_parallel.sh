...
WORKERS=24 	# Should be equal to the number of cores on each machine

source activate rmg_parallel_env
python -m scoop -n $WORKERS --host $hosts -v ../../../../../../rmg.py -pi input.py
